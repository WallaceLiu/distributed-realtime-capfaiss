...
async def run():
    ...
    async with grpc.aio.insecure_channel('localhost:50051') as channel:
        stub = core.grpc.helloworld.helloworld_pb2_grpc.GreeterStub(channel)
        response = await stub.SayHello(core.grpc.helloworld.helloworld_pb2.HelloRequest(name='you'))
