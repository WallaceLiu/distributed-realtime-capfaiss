...
if __name__ == '__main__':
    ...
    parser.add_argument('--inum', type=int, default=2000, required=False, help='')
    parser.add_argument('--anum', type=int, default=1000, required=False, help='')

    params = parser.parse_args()

    req = ReindexApiTest(params.host, params.port, params.rc_id, params.inum)
    ...
    req = AddApiTest(params.host, params.port, params.rc_id, params.anum)
